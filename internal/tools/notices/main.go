...
// (default ./cmd/...), then collects every license and notice file that
...
This file is generated by "just notices". Do not edit it by hand.

Aquifer is distributed under the BSD 3-Clause License (see LICENSE). It links
the third-party modules listed below, each under its own terms. The full text
of every applicable license and notice file is reproduced verbatim.
...
func generate(ctx context.Context, patterns []string) (string, error) {
	...
	if len(mods) == 0 {
		return header + "Aquifer currently has no third-party dependencies.\n", nil
	}
